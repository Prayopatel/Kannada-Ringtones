package com.kannada.ringtoneapp.best.songs.ringtones;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setSupportActionBar((Toolbar) findViewById(com.kannada.ringtoneapp.best.songs.ringtones.R.id.toolbar));
